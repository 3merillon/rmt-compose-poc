    ...
    while (pc < expr.length) {
      ...
      switch (op) {
        ...
        case OP.LOAD_REF: {
          ...
          this.push(`[${noteId}].${prop}`, Precedence.ATOMIC);
          break;
        }
        ...
        case OP.LOAD_BASE: {
          const varIdx = bytecode[pc++];
          const prop = this.varIndexToShortName(varIdx);
          this.push(`base.${prop}`, Precedence.ATOMIC);
          break;
        }
        ...
        case OP.DIV: {
          ...
          if (this.isBeatPattern(a, b)) {
            ...
            this.push(`beat(${noteArg})`, Precedence.ATOMIC);
          } else {
            const aStr = this.wrapIfLower(a, aPrec, Precedence.MULTIPLICATIVE);
        ...
        case OP.FIND_TEMPO: {
          ...
          this.push(`tempo(${noteArg})`, Precedence.ATOMIC);
          break;
        }
        ...
        case OP.FIND_MEASURE: {
          const [ref] = this.pop();
          const noteArg = this.extractNoteArg(ref);
          this.push(`measure(${noteArg})`, Precedence.ATOMIC);
          break;
        }
