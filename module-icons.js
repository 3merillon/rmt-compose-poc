document.addEventListener('DOMContentLoaded', function() {
  ...
  function createModuleIcon(category, filename) {
      ...
      function onPointerUp(ev) {
        ...
        if (dragStarted && moduleIcon.moduleData) {
          ...
          if (noteTarget) {
            ...
            if (noteId) {
              // Obtain the target note from myModule and call importModuleAtTarget.
  ...
  categories.forEach((category, index) => {
    ...
    sectionContainer.appendChild(createLabelIcon(category));
