...
|-----------|-------|------------|
| 1 octave up | 2/1 | `.mul(new Fraction(2))` |
| 1 octave down | 1/2 | `.div(new Fraction(2))` |
| 2 octaves up | 4/1 | `.mul(new Fraction(4))` |
| 2 octaves down | 1/4 | `.div(new Fraction(4))` |
| 3 octaves up | 8/1 | `.mul(new Fraction(8))` |
| 3 octaves down | 1/8 | `.div(new Fraction(8))` |
